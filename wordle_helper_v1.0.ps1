...
$dict = gc C:\ps_dir\wordle_helper\official.txt
$pos_1 = "\S"
$pos_2 = "\S"
$pos_3 = "\S"
$pos_4 = "\S"
...
function write-menu {
    ...
    if ($usr_input -eq 1){
        ...
        if ($wrong_pos -eq 1){
            if ($pos_1 -contains "^"){$pos_1 = $pos_1 -replace "\^",""}
            if ($pos_1 -ne "\S"){
            ...
            if ($pos_2 -contains "^"){$pos_2 = $pos_2 -replace "\^",""}
            if ($pos_2 -ne "\S"){
            ...
            if ($pos_3 -contains "^"){$pos_3 = $pos_3 -replace "\^",""}
            if ($pos_3 -ne "\S"){
            ...
            if ($pos_4 -contains "^"){$pos_4 = $pos_4 -replace "\^",""}
            if ($pos_4 -ne "\S"){
            ...
            if ($pos_5 -contains "^"){$pos_5 = $pos_5 -replace "\^",""}
            if ($pos_5 -ne "\S"){
